...
export class TableTop extends SurfaceDetector {
  ...
  protected update() {
    ...
    if (this.isMobileConnected()) {
      //HANDLE MOBILE
      var phoneForward = SIK.MobileInputData.rotation.multiplyVec3(vec3.up());
      var mobilePosition = SIK.MobileInputData.position.add(
